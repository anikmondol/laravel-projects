                ...
                <div class="category-category-insert">
                    ...
                    <form role="form" action="{{ route('blog.update', $blog->id) }}" method="POST"
                        ...
                        <div>
                            ...
                            is-invalid
                            @enderror"
                                placeholder="Slug" value="{{ $blog->slug }}" />
                            @error('slug')
                                <p class="text-danger">{{ $message }}</p>
                            @enderror
                        </div>
                        <div>
                            ...
                            <textarea id="short_description" name="short_description" id="floating_email" placeholder="Short Description"
                                class="w-full h-[170px] py-5 pl-8 text-[#262a31] outline-none text-[18px] border border-cyan-400">{!! $blog->short_description !!}</textarea>
                        ...
                        <div>
                            ...
                            <textarea id="description" name="description" id="floating_email" placeholder="Description"
                                class="w-full h-[170px] py-5 pl-8 text-[#262a31] outline-none text-[18px] border border-cyan-400">{!! $blog->description !!}</textarea>
                            @error('description')
                                <p class="text-danger">{{ $message }}</p>
                            @enderror
                        </div>
                        <div>
                            ...
                            <picture class="d-block my-4">
                                <img id="port_img" src="{{ asset('uploads/blog') }}/{{ $blog->thumbnail }}"
