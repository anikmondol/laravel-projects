...
class CategoryController extends Controller
{
    ...
    public function status($id){
        ...
        if ($category->status == 'active') {
         ...
         return redirect()->route('category.index')->with('category_success','Category Status Deactive Successful');
        } else {
         Category::find($category->id)->update([
             'status' => 'active',
             'update_at' => now(),
         ]);
         return redirect()->route('category.index')->with('category_success','Category Status Active Successful');
        }
